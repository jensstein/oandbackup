...
val Icon.IcWallpaper: ImageVector
    get() {
        if (_icWallpaper != null) {
            return _icWallpaper!!
        }
        _icWallpaper = Builder(
            name = "IcWallpaper", defaultWidth = 38.0.dp, defaultHeight =
...
private var _icWallpaper: ImageVector? = null
