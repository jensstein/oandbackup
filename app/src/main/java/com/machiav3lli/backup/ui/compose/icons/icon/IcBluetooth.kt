...
val Icon.IcBluetooth: ImageVector
    get() {
        if (_icBluetooth != null) {
            return _icBluetooth!!
        }
        _icBluetooth = Builder(
            name = "IcBluetooth", defaultWidth = 38.0.dp, defaultHeight =
...
private var _icBluetooth: ImageVector? = null
