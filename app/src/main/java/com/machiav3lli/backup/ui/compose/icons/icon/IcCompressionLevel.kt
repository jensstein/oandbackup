...
val Icon.IcCompressionLevel: ImageVector
    get() {
        if (_icCompressionLevel != null) {
            return _icCompressionLevel!!
        }
        _icCompressionLevel = Builder(
            name = "IcCompressionLevel", defaultWidth = 24.0.dp,
...
private var _icCompressionLevel: ImageVector? = null
