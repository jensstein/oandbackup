...
val Phosphor.ClockClockwise: ImageVector
    get() {
        if (_clock_clockwise != null) {
            return _clock_clockwise!!
        }
        _clock_clockwise = Builder(
...
private var _clock_clockwise: ImageVector? = null



@Preview
@Composable
fun ClockClockwisePreview() {
    Image(
