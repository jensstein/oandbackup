...
val Phosphor.PhoneIncoming: ImageVector
    get() {
        if (_phone_incoming != null) {
            return _phone_incoming!!
        }
        _phone_incoming = Builder(
            name = "Phone-incoming",
...
private var _phone_incoming: ImageVector? = null
