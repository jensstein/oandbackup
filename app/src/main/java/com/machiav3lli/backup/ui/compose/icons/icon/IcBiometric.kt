...
val Icon.IcBiometric: ImageVector
    get() {
        if (_icBiometric != null) {
            return _icBiometric!!
        }
        _icBiometric = Builder(
            name = "IcBiometric", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(
                ...
                curveTo(15.67f, 3.42f, 14.01f, 3.0f, 12.02f, 3.0f)
                ...
                curveToRelative(3.14f, -1.62f, 7.16f, -1.63f, 10.31f, -0.01f)
                ...
                curveTo(17.57f, 19.93f, 17.07f, 19.94f, 16.93f, 19.94f)
                close()
                moveTo(14.92f, 22.0f)
                ...
                curveToRelative(1.15f, 0.0f, 2.08f, -0.87f, 2.08f, -1.94f)
                ...
                curveTo(15.34f, 21.85f, 15.13f, 22.0f, 14.92f, 22.0f)
                close()
            }
        }
            .build()
...
private var _icBiometric: ImageVector? = null
