...
val Phosphor.ArrowUDownLeft: ImageVector
    get() {
        if (_arrow_u_down_left != null) {
            return _arrow_u_down_left!!
        }
        _arrow_u_down_left = Builder(
...
private var _arrow_u_down_left: ImageVector? = null



@Preview
@Composable
fun ArrowUDownLeftPreview() {
    Image(
