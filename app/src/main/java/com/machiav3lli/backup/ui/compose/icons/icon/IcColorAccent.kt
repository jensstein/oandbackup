...
val Icon.IcColorAccent: ImageVector
    get() {
        if (_icColorAccent != null) {
            return _icColorAccent!!
        }
        _icColorAccent = Builder(
            name = "IcColorAccent", defaultWidth = 32.0.dp, defaultHeight =
...
private var _icColorAccent: ImageVector? = null
