...
val Icon.IcFilter: ImageVector
    get() {
        if (_icFilter != null) {
            return _icFilter!!
        }
        _icFilter = Builder(
            name = "IcFilter", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
