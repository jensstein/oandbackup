...
const val BACKUP_FILTER_DATA_DE = 0b000100
const val BACKUP_FILTER_DATA_EXT = 0b000010
const val BACKUP_FILTER_DATA_OBB = 0b000001
val possibleBackupFilters = mutableListOf(BACKUP_FILTER_NONE, BACKUP_FILTER_APK, BACKUP_FILTER_DATA,
    BACKUP_FILTER_DATA_DE, BACKUP_FILTER_DATA_EXT, BACKUP_FILTER_DATA_OBB)
