...
const val MAIN_SPECIALFILTER_LAUNCHABLE = '5'

const val SCHED_SPECIALFILTER_ALL = 0
const val SCHED_SPECIALFILTER_LAUNCHABLE = 1
const val SCHED_SPECIALFILTER_NEW_UPDATED = 2
const val SCHED_SPECIALFILTER_OLD = 3
