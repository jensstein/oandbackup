...
import com.machiav3lli.backup.adapters.FileListAdapter;
import com.machiav3lli.backup.ui.dialogs.CreateDirectoryDialog;
...
public class FileBrowser extends BaseActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FileListAdapter(this, R.layout.item_files_list, filesList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.createDirectory) {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.filebrowser_contextSetBackupDirectory) {
