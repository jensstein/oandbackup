...
import com.machiav3lli.backup.ui.FileBrowser;

public class FileBrowserEditTextPreference extends androidx.preference.DialogPreference
{
    Button button;
    EditText mEditText;
    String mText;
    public FileBrowserEditTextPreference(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        setDialogLayoutResource(R.layout.dialog_file_browser_preference);
