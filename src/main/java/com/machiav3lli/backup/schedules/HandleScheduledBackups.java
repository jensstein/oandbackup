            ...
            new Thread(new Runnable()
            {
                public void run()
                {
                    ...
                    for(AppInfo appInfo : backupList)
                    {
                        ...
                        NotificationHelper.showNotification(context, OAndBackupX.class, id, title, appInfo.getLabel(), false);
                        ...
                        if(i == total)
                        {
                            ...
                            NotificationHelper.showNotification(context, OAndBackupX.class, id, notificationTitle, notificationMessage, true);
                        }
                        i++;
                    }
                    if(wl.isHeld())
