...
val Phosphor.`Circle-wavy-check`: ImageVector
    get() {
        if (`_circle-wavy-check` != null) {
            return `_circle-wavy-check`!!
        }
        `_circle-wavy-check` = Builder(
            name = "Circle-wavy-check", defaultWidth = 256.0.dp,
...
private var `_circle-wavy-check`: ImageVector? = null
