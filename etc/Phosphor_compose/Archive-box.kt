...
val Phosphor.`Archive-box`: ImageVector
    get() {
        if (`_archive-box` != null) {
            return `_archive-box`!!
        }
        `_archive-box` = Builder(
            name = "Archive-box", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_archive-box`: ImageVector? = null
