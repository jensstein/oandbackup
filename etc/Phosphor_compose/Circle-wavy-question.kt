...
val Phosphor.`Circle-wavy-question`: ImageVector
    get() {
        if (`_circle-wavy-question` != null) {
            return `_circle-wavy-question`!!
        }
        `_circle-wavy-question` = Builder(
            name = "Circle-wavy-question", defaultWidth = 256.0.dp,
...
private var `_circle-wavy-question`: ImageVector? = null
