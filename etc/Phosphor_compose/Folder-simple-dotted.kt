...
val Phosphor.`Folder-simple-dotted`: ImageVector
    get() {
        if (`_folder-simple-dotted` != null) {
            return `_folder-simple-dotted`!!
        }
        `_folder-simple-dotted` = Builder(
            name = "Folder-simple-dotted", defaultWidth = 256.0.dp,
...
private var `_folder-simple-dotted`: ImageVector? = null
