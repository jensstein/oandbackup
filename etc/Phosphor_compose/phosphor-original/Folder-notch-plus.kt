...
val Phosphor.`Folder-notch-plus`: ImageVector
    get() {
        if (`_folder-notch-plus` != null) {
            return `_folder-notch-plus`!!
        }
        `_folder-notch-plus` = Builder(
            name = "Folder-notch-plus", defaultWidth = 256.0.dp,
...
private var `_folder-notch-plus`: ImageVector? = null
