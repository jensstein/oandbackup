...
val Phosphor.`Text-bolder`: ImageVector
    get() {
        if (`_text-bolder` != null) {
            return `_text-bolder`!!
        }
        `_text-bolder` = Builder(
            name = "Text-bolder", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_text-bolder`: ImageVector? = null
