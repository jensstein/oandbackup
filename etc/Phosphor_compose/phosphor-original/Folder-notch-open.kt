...
val Phosphor.`Folder-notch-open`: ImageVector
    get() {
        if (`_folder-notch-open` != null) {
            return `_folder-notch-open`!!
        }
        `_folder-notch-open` = Builder(
            name = "Folder-notch-open", defaultWidth = 256.0.dp,
...
private var `_folder-notch-open`: ImageVector? = null
