...
val Phosphor.`Circle-wavy`: ImageVector
    get() {
        if (`_circle-wavy` != null) {
            return `_circle-wavy`!!
        }
        `_circle-wavy` = Builder(
            name = "Circle-wavy", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_circle-wavy`: ImageVector? = null
