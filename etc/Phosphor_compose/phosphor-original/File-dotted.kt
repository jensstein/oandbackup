...
val Phosphor.`File-dotted`: ImageVector
    get() {
        if (`_file-dotted` != null) {
            return `_file-dotted`!!
        }
        `_file-dotted` = Builder(
            name = "File-dotted", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-dotted`: ImageVector? = null
