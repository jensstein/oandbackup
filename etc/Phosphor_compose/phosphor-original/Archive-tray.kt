...
val Phosphor.`Archive-tray`: ImageVector
    get() {
        if (`_archive-tray` != null) {
            return `_archive-tray`!!
        }
        `_archive-tray` = Builder(
            name = "Archive-tray", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_archive-tray`: ImageVector? = null
