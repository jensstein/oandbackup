...
val Phosphor.`Circle-wavy-warning`: ImageVector
    get() {
        if (`_circle-wavy-warning` != null) {
            return `_circle-wavy-warning`!!
        }
        `_circle-wavy-warning` = Builder(
            name = "Circle-wavy-warning", defaultWidth = 256.0.dp,
...
private var `_circle-wavy-warning`: ImageVector? = null
