...
val Phosphor.`Folder-notch-minus`: ImageVector
    get() {
        if (`_folder-notch-minus` != null) {
            return `_folder-notch-minus`!!
        }
        `_folder-notch-minus` = Builder(
            name = "Folder-notch-minus", defaultWidth = 256.0.dp,
...
private var `_folder-notch-minus`: ImageVector? = null
