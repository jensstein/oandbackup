...
val Phosphor.`Folder-notch`: ImageVector
    get() {
        if (`_folder-notch` != null) {
            return `_folder-notch`!!
        }
        `_folder-notch` = Builder(
            name = "Folder-notch", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_folder-notch`: ImageVector? = null
