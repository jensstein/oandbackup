...
val Phosphor.CameraRotate: ImageVector
    get() {
        if (_camera_rotate != null) {
            return _camera_rotate!!
        }
        _camera_rotate = Builder(
            name = "Camera-rotate",
...
private var _camera_rotate: ImageVector? = null



@Preview
@Composable
fun CameraRotatePreview() {
    Image(
        Phosphor.CameraRotate,
        null
    )
}
