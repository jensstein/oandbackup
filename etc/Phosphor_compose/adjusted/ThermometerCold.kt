...
val Phosphor.ThermometerCold: ImageVector
    get() {
        if (_thermometer_cold != null) {
            return _thermometer_cold!!
        }
        _thermometer_cold = Builder(
...
private var _thermometer_cold: ImageVector? = null



@Preview
@Composable
fun ThermometerColdPreview() {
    Image(
        Phosphor.ThermometerCold,
        null
    )
}
