...
val Phosphor.PencilCircle: ImageVector
    get() {
        if (_pencil_circle != null) {
            return _pencil_circle!!
        }
        _pencil_circle = Builder(
            name = "Pencil-circle",
...
private var _pencil_circle: ImageVector? = null



@Preview
@Composable
fun PencilCirclePreview() {
    Image(
        Phosphor.PencilCircle,
        null
    )
}
