...
val Phosphor.CirclesThreePlus: ImageVector
    get() {
        if (_circles_three_plus != null) {
            return _circles_three_plus!!
        }
        _circles_three_plus = Builder(
...
private var _circles_three_plus: ImageVector? = null



@Preview
@Composable
fun CirclesThreePlusPreview() {
    Image(
