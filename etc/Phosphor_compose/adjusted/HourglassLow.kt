...
val Phosphor.HourglassLow: ImageVector
    get() {
        if (_hourglass_low != null) {
            return _hourglass_low!!
        }
        _hourglass_low = Builder(
            name = "Hourglass-low",
...
private var _hourglass_low: ImageVector? = null



@Preview
@Composable
fun HourglassLowPreview() {
    Image(
        Phosphor.HourglassLow,
        null
    )
}
