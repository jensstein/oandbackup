...
val Phosphor.RewindCircle: ImageVector
    get() {
        if (_rewind_circle != null) {
            return _rewind_circle!!
        }
        _rewind_circle = Builder(
            name = "Rewind-circle",
...
private var _rewind_circle: ImageVector? = null



@Preview
@Composable
fun RewindCirclePreview() {
    Image(
        Phosphor.RewindCircle,
        null
    )
}
