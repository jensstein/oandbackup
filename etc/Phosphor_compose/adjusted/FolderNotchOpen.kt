...
val Phosphor.FolderNotchOpen: ImageVector
    get() {
        if (_folder_notch_open != null) {
            return _folder_notch_open!!
        }
        _folder_notch_open = Builder(
...
private var _folder_notch_open: ImageVector? = null



@Preview
@Composable
fun FolderNotchOpenPreview() {
    Image(
        Phosphor.FolderNotchOpen,
        null
    )
}
