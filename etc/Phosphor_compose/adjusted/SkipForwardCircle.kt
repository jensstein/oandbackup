...
val Phosphor.SkipForwardCircle: ImageVector
    get() {
        if (_skip_forward_circle != null) {
            return _skip_forward_circle!!
        }
        _skip_forward_circle = Builder(
...
private var _skip_forward_circle: ImageVector? = null



@Preview
@Composable
fun SkipForwardCirclePreview() {
    Image(
        Phosphor.SkipForwardCircle,
        null
    )
}
