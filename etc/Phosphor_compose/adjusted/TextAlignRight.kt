...
val Phosphor.TextAlignRight: ImageVector
    get() {
        if (_text_align_right != null) {
            return _text_align_right!!
        }
        _text_align_right = Builder(
...
private var _text_align_right: ImageVector? = null



@Preview
@Composable
fun TextAlignRightPreview() {
    Image(
