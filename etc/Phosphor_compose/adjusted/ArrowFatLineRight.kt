...
val Phosphor.ArrowFatLineRight: ImageVector
    get() {
        if (_arrow_fat_line_right != null) {
            return _arrow_fat_line_right!!
        }
        _arrow_fat_line_right = Builder(
...
private var _arrow_fat_line_right: ImageVector? = null



@Preview
@Composable
fun ArrowFatLineRightPreview() {
    Image(
        Phosphor.ArrowFatLineRight,
        null
    )
}
