...
val Phosphor.LockLaminated: ImageVector
    get() {
        if (_lock_laminated != null) {
            return _lock_laminated!!
        }
        _lock_laminated = Builder(
            name = "Lock-laminated",
...
private var _lock_laminated: ImageVector? = null



@Preview
@Composable
fun LockLaminatedPreview() {
    Image(
        Phosphor.LockLaminated,
        null
    )
}
