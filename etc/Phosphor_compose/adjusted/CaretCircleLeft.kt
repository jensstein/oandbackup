...
val Phosphor.CaretCircleLeft: ImageVector
    get() {
        if (_caret_circle_left != null) {
            return _caret_circle_left!!
        }
        _caret_circle_left = Builder(
...
private var _caret_circle_left: ImageVector? = null



@Preview
@Composable
fun CaretCircleLeftPreview() {
    Image(
        Phosphor.CaretCircleLeft,
        null
    )
}
