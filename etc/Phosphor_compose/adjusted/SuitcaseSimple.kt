...
val Phosphor.SuitcaseSimple: ImageVector
    get() {
        if (_suitcase_simple != null) {
            return _suitcase_simple!!
        }
        _suitcase_simple = Builder(
...
private var _suitcase_simple: ImageVector? = null



@Preview
@Composable
fun SuitcaseSimplePreview() {
    Image(
        Phosphor.SuitcaseSimple,
        null
    )
}
