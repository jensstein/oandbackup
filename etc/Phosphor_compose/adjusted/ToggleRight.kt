...
val Phosphor.ToggleRight: ImageVector
    get() {
        if (_toggle_right != null) {
            return _toggle_right!!
        }
        _toggle_right = Builder(
            name = "Toggle-right",
...
private var _toggle_right: ImageVector? = null



@Preview
@Composable
fun ToggleRightPreview() {
    Image(
