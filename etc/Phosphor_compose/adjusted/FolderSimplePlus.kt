...
val Phosphor.FolderSimplePlus: ImageVector
    get() {
        if (_folder_simple_plus != null) {
            return _folder_simple_plus!!
        }
        _folder_simple_plus = Builder(
...
private var _folder_simple_plus: ImageVector? = null



@Preview
@Composable
fun FolderSimplePlusPreview() {
    Image(
