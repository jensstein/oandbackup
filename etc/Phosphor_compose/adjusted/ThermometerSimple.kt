...
val Phosphor.ThermometerSimple: ImageVector
    get() {
        if (_thermometer_simple != null) {
            return _thermometer_simple!!
        }
        _thermometer_simple = Builder(
...
private var _thermometer_simple: ImageVector? = null



@Preview
@Composable
fun ThermometerSimplePreview() {
    Image(
        Phosphor.ThermometerSimple,
        null
    )
}
