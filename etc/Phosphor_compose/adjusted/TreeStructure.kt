...
val Phosphor.TreeStructure: ImageVector
    get() {
        if (_tree_structure != null) {
            return _tree_structure!!
        }
        _tree_structure = Builder(
            name = "Tree-structure",
...
private var _tree_structure: ImageVector? = null



@Preview
@Composable
fun TreeStructurePreview() {
    Image(
        Phosphor.TreeStructure,
        null
    )
}
