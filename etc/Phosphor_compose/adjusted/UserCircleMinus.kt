...
val Phosphor.UserCircleMinus: ImageVector
    get() {
        if (_user_circle_minus != null) {
            return _user_circle_minus!!
        }
        _user_circle_minus = Builder(
...
private var _user_circle_minus: ImageVector? = null



@Preview
@Composable
fun UserCircleMinusPreview() {
    Image(
        Phosphor.UserCircleMinus,
        null
    )
}
