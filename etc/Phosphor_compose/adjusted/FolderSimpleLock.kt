...
val Phosphor.FolderSimpleLock: ImageVector
    get() {
        if (_folder_simple_lock != null) {
            return _folder_simple_lock!!
        }
        _folder_simple_lock = Builder(
...
private var _folder_simple_lock: ImageVector? = null



@Preview
@Composable
fun FolderSimpleLockPreview() {
    Image(
        Phosphor.FolderSimpleLock,
        null
    )
}
