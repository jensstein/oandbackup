...
val Phosphor.LinkSimpleBreak: ImageVector
    get() {
        if (_link_simple_break != null) {
            return _link_simple_break!!
        }
        _link_simple_break = Builder(
...
private var _link_simple_break: ImageVector? = null



@Preview
@Composable
fun LinkSimpleBreakPreview() {
    Image(
        Phosphor.LinkSimpleBreak,
        null
    )
}
