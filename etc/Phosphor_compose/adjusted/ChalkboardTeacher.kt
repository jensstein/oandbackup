...
val Phosphor.ChalkboardTeacher: ImageVector
    get() {
        if (_chalkboard_teacher != null) {
            return _chalkboard_teacher!!
        }
        _chalkboard_teacher = Builder(
...
private var _chalkboard_teacher: ImageVector? = null



@Preview
@Composable
fun ChalkboardTeacherPreview() {
    Image(
        Phosphor.ChalkboardTeacher,
        null
    )
}
