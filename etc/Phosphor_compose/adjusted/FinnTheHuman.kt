...
val Phosphor.FinnTheHuman: ImageVector
    get() {
        if (_finn_the_human != null) {
            return _finn_the_human!!
        }
        _finn_the_human = Builder(
            name = "Finn-the-human",
...
private var _finn_the_human: ImageVector? = null



@Preview
@Composable
fun FinnTheHumanPreview() {
    Image(
        Phosphor.FinnTheHuman,
        null
    )
}
