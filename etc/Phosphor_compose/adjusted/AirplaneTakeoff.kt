...
val Phosphor.AirplaneTakeoff: ImageVector
    get() {
        if (_airplane_takeoff != null) {
            return _airplane_takeoff!!
        }
        _airplane_takeoff = Builder(
...
private var _airplane_takeoff: ImageVector? = null



@Preview
@Composable
fun AirplaneTakeoffPreview() {
    Image(
        Phosphor.AirplaneTakeoff,
        null
    )
}
