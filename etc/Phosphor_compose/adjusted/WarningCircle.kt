...
val Phosphor.WarningCircle: ImageVector
    get() {
        if (_warning_circle != null) {
            return _warning_circle!!
        }
        _warning_circle = Builder(
            name = "Warning-circle",
...
private var _warning_circle: ImageVector? = null



@Preview
@Composable
fun WarningCirclePreview() {
    Image(
