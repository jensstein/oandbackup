...
val Phosphor.HighlighterCircle: ImageVector
    get() {
        if (_highlighter_circle != null) {
            return _highlighter_circle!!
        }
        _highlighter_circle = Builder(
...
private var _highlighter_circle: ImageVector? = null



@Preview
@Composable
fun HighlighterCirclePreview() {
    Image(
        Phosphor.HighlighterCircle,
        null
    )
}
