...
val Phosphor.MicrophoneStage: ImageVector
    get() {
        if (_microphone_stage != null) {
            return _microphone_stage!!
        }
        _microphone_stage = Builder(
...
private var _microphone_stage: ImageVector? = null



@Preview
@Composable
fun MicrophoneStagePreview() {
    Image(
