...
val Phosphor.MouseSimple: ImageVector
    get() {
        if (_mouse_simple != null) {
            return _mouse_simple!!
        }
        _mouse_simple = Builder(
            name = "Mouse-simple",
...
private var _mouse_simple: ImageVector? = null



@Preview
@Composable
fun MouseSimplePreview() {
    Image(
        Phosphor.MouseSimple,
        null
    )
}
