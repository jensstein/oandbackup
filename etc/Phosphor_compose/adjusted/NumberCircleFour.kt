...
val Phosphor.NumberCircleFour: ImageVector
    get() {
        if (_number_circle_four != null) {
            return _number_circle_four!!
        }
        _number_circle_four = Builder(
...
private var _number_circle_four: ImageVector? = null



@Preview
@Composable
fun NumberCircleFourPreview() {
    Image(
        Phosphor.NumberCircleFour,
        null
    )
}
