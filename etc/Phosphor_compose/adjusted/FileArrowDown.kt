...
val Phosphor.FileArrowDown: ImageVector
    get() {
        if (_file_arrow_down != null) {
            return _file_arrow_down!!
        }
        _file_arrow_down = Builder(
...
private var _file_arrow_down: ImageVector? = null



@Preview
@Composable
fun FileArrowDownPreview() {
    Image(
