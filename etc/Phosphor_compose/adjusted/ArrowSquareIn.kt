...
val Phosphor.ArrowSquareIn: ImageVector
    get() {
        if (_arrow_square_in != null) {
            return _arrow_square_in!!
        }
        _arrow_square_in = Builder(
...
private var _arrow_square_in: ImageVector? = null



@Preview
@Composable
fun ArrowSquareInPreview() {
    Image(
        Phosphor.ArrowSquareIn,
        null
    )
}
