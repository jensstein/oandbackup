...
val Phosphor.PlugsConnected: ImageVector
    get() {
        if (_plugs_connected != null) {
            return _plugs_connected!!
        }
        _plugs_connected = Builder(
...
private var _plugs_connected: ImageVector? = null



@Preview
@Composable
fun PlugsConnectedPreview() {
    Image(
