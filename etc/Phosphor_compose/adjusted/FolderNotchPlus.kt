...
val Phosphor.FolderNotchPlus: ImageVector
    get() {
        if (_folder_notch_plus != null) {
            return _folder_notch_plus!!
        }
        _folder_notch_plus = Builder(
...
private var _folder_notch_plus: ImageVector? = null



@Preview
@Composable
fun FolderNotchPlusPreview() {
    Image(
        Phosphor.FolderNotchPlus,
        null
    )
}
