...
val Phosphor.TrafficSign: ImageVector
    get() {
        if (_traffic_sign != null) {
            return _traffic_sign!!
        }
        _traffic_sign = Builder(
            name = "Traffic-sign",
...
private var _traffic_sign: ImageVector? = null



@Preview
@Composable
fun TrafficSignPreview() {
    Image(
        Phosphor.TrafficSign,
        null
    )
}
