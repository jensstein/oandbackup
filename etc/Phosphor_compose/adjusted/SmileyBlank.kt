...
val Phosphor.SmileyBlank: ImageVector
    get() {
        if (_smiley_blank != null) {
            return _smiley_blank!!
        }
        _smiley_blank = Builder(
            name = "Smiley-blank",
...
private var _smiley_blank: ImageVector? = null



@Preview
@Composable
fun SmileyBlankPreview() {
    Image(
        Phosphor.SmileyBlank,
        null
    )
}
