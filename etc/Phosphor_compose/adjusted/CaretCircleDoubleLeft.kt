...
val Phosphor.CaretCircleDoubleLeft: ImageVector
    get() {
        if (_caret_circle_double_left != null) {
            return _caret_circle_double_left!!
        }
        _caret_circle_double_left = Builder(
...
private var _caret_circle_double_left: ImageVector? = null



@Preview
@Composable
fun CaretCircleDoubleLeftPreview() {
    Image(
        Phosphor.CaretCircleDoubleLeft,
        null
    )
}
