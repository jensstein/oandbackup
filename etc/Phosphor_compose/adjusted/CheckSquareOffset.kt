...
val Phosphor.CheckSquareOffset: ImageVector
    get() {
        if (_check_square_offset != null) {
            return _check_square_offset!!
        }
        _check_square_offset = Builder(
...
private var _check_square_offset: ImageVector? = null



@Preview
@Composable
fun CheckSquareOffsetPreview() {
    Image(
        Phosphor.CheckSquareOffset,
        null
    )
}
