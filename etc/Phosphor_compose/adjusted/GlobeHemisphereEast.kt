...
val Phosphor.GlobeHemisphereEast: ImageVector
    get() {
        if (_globe_hemisphere_east != null) {
            return _globe_hemisphere_east!!
        }
        _globe_hemisphere_east = Builder(
...
private var _globe_hemisphere_east: ImageVector? = null



@Preview
@Composable
fun GlobeHemisphereEastPreview() {
    Image(
        Phosphor.GlobeHemisphereEast,
        null
    )
}
