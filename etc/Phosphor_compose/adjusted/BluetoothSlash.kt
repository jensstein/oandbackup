...
val Phosphor.BluetoothSlash: ImageVector
    get() {
        if (_bluetooth_slash != null) {
            return _bluetooth_slash!!
        }
        _bluetooth_slash = Builder(
...
private var _bluetooth_slash: ImageVector? = null



@Preview
@Composable
fun BluetoothSlashPreview() {
    Image(
        Phosphor.BluetoothSlash,
        null
    )
}
