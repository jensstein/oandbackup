...
val Phosphor.DeviceTabletSpeaker: ImageVector
    get() {
        if (_device_tablet_speaker != null) {
            return _device_tablet_speaker!!
        }
        _device_tablet_speaker = Builder(
...
private var _device_tablet_speaker: ImageVector? = null



@Preview
@Composable
fun DeviceTabletSpeakerPreview() {
    Image(
        Phosphor.DeviceTabletSpeaker,
        null
    )
}
