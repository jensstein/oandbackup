...
val Phosphor.LockSimpleOpen: ImageVector
    get() {
        if (_lock_simple_open != null) {
            return _lock_simple_open!!
        }
        _lock_simple_open = Builder(
...
private var _lock_simple_open: ImageVector? = null



@Preview
@Composable
fun LockSimpleOpenPreview() {
    Image(
