...
val Phosphor.GitlabLogoSimple: ImageVector
    get() {
        if (_gitlab_logo_simple != null) {
            return _gitlab_logo_simple!!
        }
        _gitlab_logo_simple = Builder(
...
private var _gitlab_logo_simple: ImageVector? = null



@Preview
@Composable
fun GitlabLogoSimplePreview() {
    Image(
        Phosphor.GitlabLogoSimple,
        null
    )
}
