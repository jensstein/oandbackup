...
val Phosphor.MagnetStraight: ImageVector
    get() {
        if (_magnet_straight != null) {
            return _magnet_straight!!
        }
        _magnet_straight = Builder(
...
private var _magnet_straight: ImageVector? = null



@Preview
@Composable
fun MagnetStraightPreview() {
    Image(
        Phosphor.MagnetStraight,
        null
    )
}
