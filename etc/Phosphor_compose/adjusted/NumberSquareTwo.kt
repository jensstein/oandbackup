...
val Phosphor.NumberSquareTwo: ImageVector
    get() {
        if (_number_square_two != null) {
            return _number_square_two!!
        }
        _number_square_two = Builder(
...
private var _number_square_two: ImageVector? = null



@Preview
@Composable
fun NumberSquareTwoPreview() {
    Image(
        Phosphor.NumberSquareTwo,
        null
    )
}
