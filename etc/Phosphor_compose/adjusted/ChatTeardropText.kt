...
val Phosphor.ChatTeardropText: ImageVector
    get() {
        if (_chat_teardrop_text != null) {
            return _chat_teardrop_text!!
        }
        _chat_teardrop_text = Builder(
...
private var _chat_teardrop_text: ImageVector? = null



@Preview
@Composable
fun ChatTeardropTextPreview() {
    Image(
        Phosphor.ChatTeardropText,
        null
    )
}
