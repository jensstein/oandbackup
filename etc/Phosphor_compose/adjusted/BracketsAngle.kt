...
val Phosphor.BracketsAngle: ImageVector
    get() {
        if (_brackets_angle != null) {
            return _brackets_angle!!
        }
        _brackets_angle = Builder(
            name = "Brackets-angle",
...
private var _brackets_angle: ImageVector? = null



@Preview
@Composable
fun BracketsAnglePreview() {
    Image(
        Phosphor.BracketsAngle,
        null
    )
}
