...
val Phosphor.NumberThree: ImageVector
    get() {
        if (_number_three != null) {
            return _number_three!!
        }
        _number_three = Builder(
            name = "Number-three",
...
private var _number_three: ImageVector? = null
