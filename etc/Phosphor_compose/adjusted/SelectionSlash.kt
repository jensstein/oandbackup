...
val Phosphor.SelectionSlash: ImageVector
    get() {
        if (_selection_slash != null) {
            return _selection_slash!!
        }
        _selection_slash = Builder(
...
private var _selection_slash: ImageVector? = null



@Preview
@Composable
fun SelectionSlashPreview() {
    Image(
        Phosphor.SelectionSlash,
        null
    )
}
