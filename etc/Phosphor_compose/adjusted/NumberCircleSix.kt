...
val Phosphor.NumberCircleSix: ImageVector
    get() {
        if (_number_circle_six != null) {
            return _number_circle_six!!
        }
        _number_circle_six = Builder(
...
private var _number_circle_six: ImageVector? = null



@Preview
@Composable
fun NumberCircleSixPreview() {
    Image(
        Phosphor.NumberCircleSix,
        null
    )
}
