...
val Phosphor.MusicNotesPlus: ImageVector
    get() {
        if (_music_notes_plus != null) {
            return _music_notes_plus!!
        }
        _music_notes_plus = Builder(
...
private var _music_notes_plus: ImageVector? = null



@Preview
@Composable
fun MusicNotesPlusPreview() {
    Image(
        Phosphor.MusicNotesPlus,
        null
    )
}
