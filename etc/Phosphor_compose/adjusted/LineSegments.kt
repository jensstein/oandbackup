...
val Phosphor.LineSegments: ImageVector
    get() {
        if (_line_segments != null) {
            return _line_segments!!
        }
        _line_segments = Builder(
            name = "Line-segments",
...
private var _line_segments: ImageVector? = null



@Preview
@Composable
fun LineSegmentsPreview() {
    Image(
