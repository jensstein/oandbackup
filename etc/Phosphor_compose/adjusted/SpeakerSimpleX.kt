...
val Phosphor.SpeakerSimpleX: ImageVector
    get() {
        if (_speaker_simple_x != null) {
            return _speaker_simple_x!!
        }
        _speaker_simple_x = Builder(
...
private var _speaker_simple_x: ImageVector? = null



@Preview
@Composable
fun SpeakerSimpleXPreview() {
    Image(
        Phosphor.SpeakerSimpleX,
        null
    )
}
