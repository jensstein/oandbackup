...
val Phosphor.SelectionForeground: ImageVector
    get() {
        if (_selection_foreground != null) {
            return _selection_foreground!!
        }
        _selection_foreground = Builder(
...
private var _selection_foreground: ImageVector? = null



@Preview
@Composable
fun SelectionForegroundPreview() {
    Image(
        Phosphor.SelectionForeground,
        null
    )
}
