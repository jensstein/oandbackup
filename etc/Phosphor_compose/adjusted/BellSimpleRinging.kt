...
val Phosphor.BellSimpleRinging: ImageVector
    get() {
        if (_bell_simple_ringing != null) {
            return _bell_simple_ringing!!
        }
        _bell_simple_ringing = Builder(
...
private var _bell_simple_ringing: ImageVector? = null



@Preview
@Composable
fun BellSimpleRingingPreview() {
    Image(
        Phosphor.BellSimpleRinging,
        null
    )
}
