...
val Phosphor.ArrowBendDoubleUpLeft: ImageVector
    get() {
        if (_arrow_bend_double_up_left != null) {
            return _arrow_bend_double_up_left!!
        }
        _arrow_bend_double_up_left = Builder(
...
private var _arrow_bend_double_up_left: ImageVector? = null



@Preview
@Composable
fun ArrowBendDoubleUpLeftPreview() {
    Image(
        Phosphor.ArrowBendDoubleUpLeft,
        null
    )
}
