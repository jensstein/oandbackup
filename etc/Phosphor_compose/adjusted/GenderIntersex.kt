...
val Phosphor.GenderIntersex: ImageVector
    get() {
        if (_gender_intersex != null) {
            return _gender_intersex!!
        }
        _gender_intersex = Builder(
...
private var _gender_intersex: ImageVector? = null



@Preview
@Composable
fun GenderIntersexPreview() {
    Image(
        Phosphor.GenderIntersex,
        null
    )
}
