...
val Phosphor.CodesandboxLogo: ImageVector
    get() {
        if (_codesandbox_logo != null) {
            return _codesandbox_logo!!
        }
        _codesandbox_logo = Builder(
...
private var _codesandbox_logo: ImageVector? = null



@Preview
@Composable
fun CodesandboxLogoPreview() {
    Image(
        Phosphor.CodesandboxLogo,
        null
    )
}
