...
val Phosphor.ShuffleAngular: ImageVector
    get() {
        if (_shuffle_angular != null) {
            return _shuffle_angular!!
        }
        _shuffle_angular = Builder(
...
private var _shuffle_angular: ImageVector? = null



@Preview
@Composable
fun ShuffleAngularPreview() {
    Image(
        Phosphor.ShuffleAngular,
        null
    )
}
