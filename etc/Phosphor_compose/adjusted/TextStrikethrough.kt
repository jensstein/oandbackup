...
val Phosphor.TextStrikethrough: ImageVector
    get() {
        if (_text_strikethrough != null) {
            return _text_strikethrough!!
        }
        _text_strikethrough = Builder(
...
private var _text_strikethrough: ImageVector? = null



@Preview
@Composable
fun TextStrikethroughPreview() {
    Image(
