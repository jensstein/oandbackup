...
val Phosphor.BehanceLogo: ImageVector
    get() {
        if (_behance_logo != null) {
            return _behance_logo!!
        }
        _behance_logo = Builder(
            name = "Behance-logo",
...
private var _behance_logo: ImageVector? = null



@Preview
@Composable
fun BehanceLogoPreview() {
    Image(
        Phosphor.BehanceLogo,
        null
    )
}
