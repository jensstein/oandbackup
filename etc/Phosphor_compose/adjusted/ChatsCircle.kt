...
val Phosphor.ChatsCircle: ImageVector
    get() {
        if (_chats_circle != null) {
            return _chats_circle!!
        }
        _chats_circle = Builder(
            name = "Chats-circle",
...
private var _chats_circle: ImageVector? = null



@Preview
@Composable
fun ChatsCirclePreview() {
    Image(
