...
val Phosphor.LightbulbFilament: ImageVector
    get() {
        if (_lightbulb_filament != null) {
            return _lightbulb_filament!!
        }
        _lightbulb_filament = Builder(
...
private var _lightbulb_filament: ImageVector? = null



@Preview
@Composable
fun LightbulbFilamentPreview() {
    Image(
