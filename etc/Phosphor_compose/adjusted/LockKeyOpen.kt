...
val Phosphor.LockKeyOpen: ImageVector
    get() {
        if (_lock_key_open != null) {
            return _lock_key_open!!
        }
        _lock_key_open = Builder(
            name = "Lock-key-open",
...
private var _lock_key_open: ImageVector? = null



@Preview
@Composable
fun LockKeyOpenPreview() {
    Image(
        Phosphor.LockKeyOpen,
        null
    )
}
