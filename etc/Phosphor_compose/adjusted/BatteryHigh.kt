...
val Phosphor.BatteryHigh: ImageVector
    get() {
        if (_battery_high != null) {
            return _battery_high!!
        }
        _battery_high = Builder(
            name = "Battery-high",
...
private var _battery_high: ImageVector? = null



@Preview
@Composable
fun BatteryHighPreview() {
    Image(
        Phosphor.BatteryHigh,
        null
    )
}
