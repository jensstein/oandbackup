...
val Phosphor.NumberSquareNine: ImageVector
    get() {
        if (_number_square_nine != null) {
            return _number_square_nine!!
        }
        _number_square_nine = Builder(
...
private var _number_square_nine: ImageVector? = null



@Preview
@Composable
fun NumberSquareNinePreview() {
    Image(
        Phosphor.NumberSquareNine,
        null
    )
}
