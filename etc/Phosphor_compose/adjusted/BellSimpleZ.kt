...
val Phosphor.BellSimpleZ: ImageVector
    get() {
        if (_bell_simple_z != null) {
            return _bell_simple_z!!
        }
        _bell_simple_z = Builder(
            name = "Bell-simple-z",
...
private var _bell_simple_z: ImageVector? = null



@Preview
@Composable
fun BellSimpleZPreview() {
    Image(
        Phosphor.BellSimpleZ,
        null
    )
}
