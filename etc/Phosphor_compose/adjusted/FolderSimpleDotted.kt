...
val Phosphor.FolderSimpleDotted: ImageVector
    get() {
        if (_folder_simple_dotted != null) {
            return _folder_simple_dotted!!
        }
        _folder_simple_dotted = Builder(
...
private var _folder_simple_dotted: ImageVector? = null



@Preview
@Composable
fun FolderSimpleDottedPreview() {
    Image(
        Phosphor.FolderSimpleDotted,
        null
    )
}
