...
val Phosphor.BatteryWarning: ImageVector
    get() {
        if (_battery_warning != null) {
            return _battery_warning!!
        }
        _battery_warning = Builder(
...
private var _battery_warning: ImageVector? = null



@Preview
@Composable
fun BatteryWarningPreview() {
    Image(
        Phosphor.BatteryWarning,
        null
    )
}
