...
val Phosphor.StackOverflowLogo: ImageVector
    get() {
        if (_stack_overflow_logo != null) {
            return _stack_overflow_logo!!
        }
        _stack_overflow_logo = Builder(
...
private var _stack_overflow_logo: ImageVector? = null



@Preview
@Composable
fun StackOverflowLogoPreview() {
    Image(
        Phosphor.StackOverflowLogo,
        null
    )
}
