...
val Phosphor.DotsThreeVertical: ImageVector
    get() {
        if (_dots_three_vertical != null) {
            return _dots_three_vertical!!
        }
        _dots_three_vertical = Builder(
...
private var _dots_three_vertical: ImageVector? = null



@Preview
@Composable
fun DotsThreeVerticalPreview() {
    Image(
