...
val Phosphor.ArrowBendUpRight: ImageVector
    get() {
        if (_arrow_bend_up_right != null) {
            return _arrow_bend_up_right!!
        }
        _arrow_bend_up_right = Builder(
...
private var _arrow_bend_up_right: ImageVector? = null



@Preview
@Composable
fun ArrowBendUpRightPreview() {
    Image(
