...
val Phosphor.GoogleChromeLogo: ImageVector
    get() {
        if (_google_chrome_logo != null) {
            return _google_chrome_logo!!
        }
        _google_chrome_logo = Builder(
...
private var _google_chrome_logo: ImageVector? = null



@Preview
@Composable
fun GoogleChromeLogoPreview() {
    Image(
        Phosphor.GoogleChromeLogo,
        null
    )
}
