...
val Phosphor.ArrowFatLinesUp: ImageVector
    get() {
        if (_arrow_fat_lines_up != null) {
            return _arrow_fat_lines_up!!
        }
        _arrow_fat_lines_up = Builder(
...
private var _arrow_fat_lines_up: ImageVector? = null



@Preview
@Composable
fun ArrowFatLinesUpPreview() {
    Image(
        Phosphor.ArrowFatLinesUp,
        null
    )
}
