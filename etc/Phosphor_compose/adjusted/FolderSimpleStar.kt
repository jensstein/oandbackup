...
val Phosphor.FolderSimpleStar: ImageVector
    get() {
        if (_folder_simple_star != null) {
            return _folder_simple_star!!
        }
        _folder_simple_star = Builder(
...
private var _folder_simple_star: ImageVector? = null



@Preview
@Composable
fun FolderSimpleStarPreview() {
    Image(
        Phosphor.FolderSimpleStar,
        null
    )
}
