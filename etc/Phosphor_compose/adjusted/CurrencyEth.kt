...
val Phosphor.CurrencyEth: ImageVector
    get() {
        if (_currency_eth != null) {
            return _currency_eth!!
        }
        _currency_eth = Builder(
            name = "Currency-eth",
...
private var _currency_eth: ImageVector? = null



@Preview
@Composable
fun CurrencyEthPreview() {
    Image(
        Phosphor.CurrencyEth,
        null
    )
}
