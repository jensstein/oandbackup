...
val Phosphor.CameraSlash: ImageVector
    get() {
        if (_camera_slash != null) {
            return _camera_slash!!
        }
        _camera_slash = Builder(
            name = "Camera-slash",
...
private var _camera_slash: ImageVector? = null



@Preview
@Composable
fun CameraSlashPreview() {
    Image(
        Phosphor.CameraSlash,
        null
    )
}
