...
val Phosphor.ChatCenteredText: ImageVector
    get() {
        if (_chat_centered_text != null) {
            return _chat_centered_text!!
        }
        _chat_centered_text = Builder(
...
private var _chat_centered_text: ImageVector? = null



@Preview
@Composable
fun ChatCenteredTextPreview() {
    Image(
        Phosphor.ChatCenteredText,
        null
    )
}
