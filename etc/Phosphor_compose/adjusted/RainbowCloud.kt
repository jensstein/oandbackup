...
val Phosphor.RainbowCloud: ImageVector
    get() {
        if (_rainbow_cloud != null) {
            return _rainbow_cloud!!
        }
        _rainbow_cloud = Builder(
            name = "Rainbow-cloud",
...
private var _rainbow_cloud: ImageVector? = null



@Preview
@Composable
fun RainbowCloudPreview() {
    Image(
        Phosphor.RainbowCloud,
        null
    )
}
