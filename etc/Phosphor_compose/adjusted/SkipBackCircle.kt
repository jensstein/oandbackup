...
val Phosphor.SkipBackCircle: ImageVector
    get() {
        if (_skip_back_circle != null) {
            return _skip_back_circle!!
        }
        _skip_back_circle = Builder(
...
private var _skip_back_circle: ImageVector? = null



@Preview
@Composable
fun SkipBackCirclePreview() {
    Image(
        Phosphor.SkipBackCircle,
        null
    )
}
