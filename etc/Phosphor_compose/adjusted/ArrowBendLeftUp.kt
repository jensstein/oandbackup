...
val Phosphor.ArrowBendLeftUp: ImageVector
    get() {
        if (_arrow_bend_left_up != null) {
            return _arrow_bend_left_up!!
        }
        _arrow_bend_left_up = Builder(
...
private var _arrow_bend_left_up: ImageVector? = null



@Preview
@Composable
fun ArrowBendLeftUpPreview() {
    Image(
        Phosphor.ArrowBendLeftUp,
        null
    )
}
