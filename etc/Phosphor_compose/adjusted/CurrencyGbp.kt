...
val Phosphor.CurrencyGbp: ImageVector
    get() {
        if (_currency_gbp != null) {
            return _currency_gbp!!
        }
        _currency_gbp = Builder(
            name = "Currency-gbp",
...
private var _currency_gbp: ImageVector? = null



@Preview
@Composable
fun CurrencyGbpPreview() {
    Image(
        Phosphor.CurrencyGbp,
        null
    )
}
