...
val Phosphor.CircleDashed: ImageVector
    get() {
        if (_circle_dashed != null) {
            return _circle_dashed!!
        }
        _circle_dashed = Builder(
            name = "Circle-dashed",
...
private var _circle_dashed: ImageVector? = null



@Preview
@Composable
fun CircleDashedPreview() {
    Image(
