...
val Phosphor.FolderSimpleUser: ImageVector
    get() {
        if (_folder_simple_user != null) {
            return _folder_simple_user!!
        }
        _folder_simple_user = Builder(
...
private var _folder_simple_user: ImageVector? = null



@Preview
@Composable
fun FolderSimpleUserPreview() {
    Image(
        Phosphor.FolderSimpleUser,
        null
    )
}
