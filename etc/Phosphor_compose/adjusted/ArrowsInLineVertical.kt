...
val Phosphor.ArrowsInLineVertical: ImageVector
    get() {
        if (_arrows_in_line_vertical != null) {
            return _arrows_in_line_vertical!!
        }
        _arrows_in_line_vertical = Builder(
...
private var _arrows_in_line_vertical: ImageVector? = null



@Preview
@Composable
fun ArrowsInLineVerticalPreview() {
    Image(
