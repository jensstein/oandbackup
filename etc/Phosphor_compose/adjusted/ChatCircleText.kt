...
val Phosphor.ChatCircleText: ImageVector
    get() {
        if (_chat_circle_text != null) {
            return _chat_circle_text!!
        }
        _chat_circle_text = Builder(
...
private var _chat_circle_text: ImageVector? = null



@Preview
@Composable
fun ChatCircleTextPreview() {
    Image(
