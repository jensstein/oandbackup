...
val Phosphor.MagnifyingGlassMinus: ImageVector
    get() {
        if (_magnifying_glass_minus != null) {
            return _magnifying_glass_minus!!
        }
        _magnifying_glass_minus = Builder(
...
private var _magnifying_glass_minus: ImageVector? = null



@Preview
@Composable
fun MagnifyingGlassMinusPreview() {
    Image(
