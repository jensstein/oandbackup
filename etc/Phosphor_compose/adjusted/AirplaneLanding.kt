...
val Phosphor.AirplaneLanding: ImageVector
    get() {
        if (_airplane_landing != null) {
            return _airplane_landing!!
        }
        _airplane_landing = Builder(
...
private var _airplane_landing: ImageVector? = null



@Preview
@Composable
fun AirplaneLandingPreview() {
    Image(
        Phosphor.AirplaneLanding,
        null
    )
}
