...
val Phosphor.FlowerLotus: ImageVector
    get() {
        if (_flower_lotus != null) {
            return _flower_lotus!!
        }
        _flower_lotus = Builder(
            name = "Flower-lotus",
...
private var _flower_lotus: ImageVector? = null



@Preview
@Composable
fun FlowerLotusPreview() {
    Image(
        Phosphor.FlowerLotus,
        null
    )
}
