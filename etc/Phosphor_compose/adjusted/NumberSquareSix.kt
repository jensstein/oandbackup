...
val Phosphor.NumberSquareSix: ImageVector
    get() {
        if (_number_square_six != null) {
            return _number_square_six!!
        }
        _number_square_six = Builder(
...
private var _number_square_six: ImageVector? = null



@Preview
@Composable
fun NumberSquareSixPreview() {
    Image(
        Phosphor.NumberSquareSix,
        null
    )
}
