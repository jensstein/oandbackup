...
val Phosphor.FolderSimpleMinus: ImageVector
    get() {
        if (_folder_simple_minus != null) {
            return _folder_simple_minus!!
        }
        _folder_simple_minus = Builder(
...
private var _folder_simple_minus: ImageVector? = null



@Preview
@Composable
fun FolderSimpleMinusPreview() {
    Image(
        Phosphor.FolderSimpleMinus,
        null
    )
}
