...
val Phosphor.ArrowFatLinesLeft: ImageVector
    get() {
        if (_arrow_fat_lines_left != null) {
            return _arrow_fat_lines_left!!
        }
        _arrow_fat_lines_left = Builder(
...
private var _arrow_fat_lines_left: ImageVector? = null



@Preview
@Composable
fun ArrowFatLinesLeftPreview() {
    Image(
        Phosphor.ArrowFatLinesLeft,
        null
    )
}
