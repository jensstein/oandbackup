...
val Phosphor.NumberSquareFour: ImageVector
    get() {
        if (_number_square_four != null) {
            return _number_square_four!!
        }
        _number_square_four = Builder(
...
private var _number_square_four: ImageVector? = null



@Preview
@Composable
fun NumberSquareFourPreview() {
    Image(
        Phosphor.NumberSquareFour,
        null
    )
}
