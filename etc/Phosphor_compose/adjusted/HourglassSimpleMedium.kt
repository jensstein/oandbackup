...
val Phosphor.HourglassSimpleMedium: ImageVector
    get() {
        if (_hourglass_simple_medium != null) {
            return _hourglass_simple_medium!!
        }
        _hourglass_simple_medium = Builder(
...
private var _hourglass_simple_medium: ImageVector? = null



@Preview
@Composable
fun HourglassSimpleMediumPreview() {
    Image(
        Phosphor.HourglassSimpleMedium,
        null
    )
}
