...
val Phosphor.ArrowFatLineUp: ImageVector
    get() {
        if (_arrow_fat_line_up != null) {
            return _arrow_fat_line_up!!
        }
        _arrow_fat_line_up = Builder(
...
private var _arrow_fat_line_up: ImageVector? = null



@Preview
@Composable
fun ArrowFatLineUpPreview() {
    Image(
        Phosphor.ArrowFatLineUp,
        null
    )
}
