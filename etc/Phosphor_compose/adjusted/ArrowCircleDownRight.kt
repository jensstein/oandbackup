...
val Phosphor.ArrowCircleDownRight: ImageVector
    get() {
        if (_arrow_circle_down_right != null) {
            return _arrow_circle_down_right!!
        }
        _arrow_circle_down_right = Builder(
...
private var _arrow_circle_down_right: ImageVector? = null



@Preview
@Composable
fun ArrowCircleDownRightPreview() {
    Image(
        Phosphor.ArrowCircleDownRight,
        null
    )
}
