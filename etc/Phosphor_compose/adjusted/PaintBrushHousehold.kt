...
val Phosphor.PaintBrushHousehold: ImageVector
    get() {
        if (_paint_brush_household != null) {
            return _paint_brush_household!!
        }
        _paint_brush_household = Builder(
...
private var _paint_brush_household: ImageVector? = null



@Preview
@Composable
fun PaintBrushHouseholdPreview() {
    Image(
        Phosphor.PaintBrushHousehold,
        null
    )
}
