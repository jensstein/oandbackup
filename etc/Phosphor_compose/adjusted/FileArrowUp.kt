...
val Phosphor.FileArrowUp: ImageVector
    get() {
        if (_file_arrow_up != null) {
            return _file_arrow_up!!
        }
        _file_arrow_up = Builder(
            name = "File-arrow-up",
...
private var _file_arrow_up: ImageVector? = null



@Preview
@Composable
fun FileArrowUpPreview() {
    Image(
