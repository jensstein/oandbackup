...
val Phosphor.FolderNotchMinus: ImageVector
    get() {
        if (_folder_notch_minus != null) {
            return _folder_notch_minus!!
        }
        _folder_notch_minus = Builder(
...
private var _folder_notch_minus: ImageVector? = null



@Preview
@Composable
fun FolderNotchMinusPreview() {
    Image(
        Phosphor.FolderNotchMinus,
        null
    )
}
