...
val Phosphor.NumberSquareSeven: ImageVector
    get() {
        if (_number_square_seven != null) {
            return _number_square_seven!!
        }
        _number_square_seven = Builder(
...
private var _number_square_seven: ImageVector? = null



@Preview
@Composable
fun NumberSquareSevenPreview() {
    Image(
        Phosphor.NumberSquareSeven,
        null
    )
}
