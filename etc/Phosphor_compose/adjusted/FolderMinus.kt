...
val Phosphor.FolderMinus: ImageVector
    get() {
        if (_folder_minus != null) {
            return _folder_minus!!
        }
        _folder_minus = Builder(
            name = "Folder-minus",
...
private var _folder_minus: ImageVector? = null



@Preview
@Composable
fun FolderMinusPreview() {
    Image(
        Phosphor.FolderMinus,
        null
    )
}
