...
val Phosphor.CurrencyInr: ImageVector
    get() {
        if (_currency_inr != null) {
            return _currency_inr!!
        }
        _currency_inr = Builder(
            name = "Currency-inr",
...
private var _currency_inr: ImageVector? = null



@Preview
@Composable
fun CurrencyInrPreview() {
    Image(
