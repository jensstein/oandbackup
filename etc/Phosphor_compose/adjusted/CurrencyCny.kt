...
val Phosphor.CurrencyCny: ImageVector
    get() {
        if (_currency_cny != null) {
            return _currency_cny!!
        }
        _currency_cny = Builder(
            name = "Currency-cny",
...
private var _currency_cny: ImageVector? = null



@Preview
@Composable
fun CurrencyCnyPreview() {
    Image(
        Phosphor.CurrencyCny,
        null
    )
}
