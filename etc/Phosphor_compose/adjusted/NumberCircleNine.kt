...
val Phosphor.NumberCircleNine: ImageVector
    get() {
        if (_number_circle_nine != null) {
            return _number_circle_nine!!
        }
        _number_circle_nine = Builder(
...
private var _number_circle_nine: ImageVector? = null



@Preview
@Composable
fun NumberCircleNinePreview() {
    Image(
        Phosphor.NumberCircleNine,
        null
    )
}
