...
val Phosphor.BellSimpleSlash: ImageVector
    get() {
        if (_bell_simple_slash != null) {
            return _bell_simple_slash!!
        }
        _bell_simple_slash = Builder(
...
private var _bell_simple_slash: ImageVector? = null



@Preview
@Composable
fun BellSimpleSlashPreview() {
    Image(
        Phosphor.BellSimpleSlash,
        null
    )
}
