...
val Phosphor.ProjectorScreenChart: ImageVector
    get() {
        if (_projector_screen_chart != null) {
            return _projector_screen_chart!!
        }
        _projector_screen_chart = Builder(
...
private var _projector_screen_chart: ImageVector? = null



@Preview
@Composable
fun ProjectorScreenChartPreview() {
    Image(
        Phosphor.ProjectorScreenChart,
        null
    )
}
