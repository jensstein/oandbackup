...
val Phosphor.FolderDotted: ImageVector
    get() {
        if (_folder_dotted != null) {
            return _folder_dotted!!
        }
        _folder_dotted = Builder(
            name = "Folder-dotted",
...
private var _folder_dotted: ImageVector? = null



@Preview
@Composable
fun FolderDottedPreview() {
    Image(
        Phosphor.FolderDotted,
        null
    )
}
