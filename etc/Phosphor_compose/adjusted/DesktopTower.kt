...
val Phosphor.DesktopTower: ImageVector
    get() {
        if (_desktop_tower != null) {
            return _desktop_tower!!
        }
        _desktop_tower = Builder(
            name = "Desktop-tower",
...
private var _desktop_tower: ImageVector? = null



@Preview
@Composable
fun DesktopTowerPreview() {
    Image(
        Phosphor.DesktopTower,
        null
    )
}
