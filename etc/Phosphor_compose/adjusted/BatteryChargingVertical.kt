...
val Phosphor.BatteryChargingVertical: ImageVector
    get() {
        if (_battery_charging_vertical != null) {
            return _battery_charging_vertical!!
        }
        _battery_charging_vertical = Builder(
...
private var _battery_charging_vertical: ImageVector? = null



@Preview
@Composable
fun BatteryChargingVerticalPreview() {
    Image(
        Phosphor.BatteryChargingVertical,
        null
    )
}
