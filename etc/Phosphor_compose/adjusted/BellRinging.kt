...
val Phosphor.BellRinging: ImageVector
    get() {
        if (_bell_ringing != null) {
            return _bell_ringing!!
        }
        _bell_ringing = Builder(
            name = "Bell-ringing",
...
private var _bell_ringing: ImageVector? = null



@Preview
@Composable
fun BellRingingPreview() {
    Image(
