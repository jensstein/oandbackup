...
val Phosphor.LightningSlash: ImageVector
    get() {
        if (_lightning_slash != null) {
            return _lightning_slash!!
        }
        _lightning_slash = Builder(
...
private var _lightning_slash: ImageVector? = null



@Preview
@Composable
fun LightningSlashPreview() {
    Image(
        Phosphor.LightningSlash,
        null
    )
}
