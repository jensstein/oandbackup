...
val Phosphor.CaretDoubleDown: ImageVector
    get() {
        if (_caret_double_down != null) {
            return _caret_double_down!!
        }
        _caret_double_down = Builder(
...
private var _caret_double_down: ImageVector? = null



@Preview
@Composable
fun CaretDoubleDownPreview() {
    Image(
