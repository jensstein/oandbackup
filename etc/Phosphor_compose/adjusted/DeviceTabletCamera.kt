...
val Phosphor.DeviceTabletCamera: ImageVector
    get() {
        if (_device_tablet_camera != null) {
            return _device_tablet_camera!!
        }
        _device_tablet_camera = Builder(
...
private var _device_tablet_camera: ImageVector? = null



@Preview
@Composable
fun DeviceTabletCameraPreview() {
    Image(
        Phosphor.DeviceTabletCamera,
        null
    )
}
