...
val Phosphor.MonitorPlay: ImageVector
    get() {
        if (_monitor_play != null) {
            return _monitor_play!!
        }
        _monitor_play = Builder(
            name = "Monitor-play",
...
private var _monitor_play: ImageVector? = null



@Preview
@Composable
fun MonitorPlayPreview() {
    Image(
        Phosphor.MonitorPlay,
        null
    )
}
