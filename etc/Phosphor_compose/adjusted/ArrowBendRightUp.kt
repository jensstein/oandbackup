...
val Phosphor.ArrowBendRightUp: ImageVector
    get() {
        if (_arrow_bend_right_up != null) {
            return _arrow_bend_right_up!!
        }
        _arrow_bend_right_up = Builder(
...
private var _arrow_bend_right_up: ImageVector? = null



@Preview
@Composable
fun ArrowBendRightUpPreview() {
    Image(
        Phosphor.ArrowBendRightUp,
        null
    )
}
