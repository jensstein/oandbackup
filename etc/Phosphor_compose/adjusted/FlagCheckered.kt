...
val Phosphor.FlagCheckered: ImageVector
    get() {
        if (_flag_checkered != null) {
            return _flag_checkered!!
        }
        _flag_checkered = Builder(
            name = "Flag-checkered",
...
private var _flag_checkered: ImageVector? = null



@Preview
@Composable
fun FlagCheckeredPreview() {
    Image(
        Phosphor.FlagCheckered,
        null
    )
}
