...
val Phosphor.ChatCircleDots: ImageVector
    get() {
        if (_chat_circle_dots != null) {
            return _chat_circle_dots!!
        }
        _chat_circle_dots = Builder(
...
private var _chat_circle_dots: ImageVector? = null



@Preview
@Composable
fun ChatCircleDotsPreview() {
    Image(
