...
val Phosphor.ChartPieSlice: ImageVector
    get() {
        if (_chart_pie_slice != null) {
            return _chart_pie_slice!!
        }
        _chart_pie_slice = Builder(
...
private var _chart_pie_slice: ImageVector? = null



@Preview
@Composable
fun ChartPieSlicePreview() {
    Image(
