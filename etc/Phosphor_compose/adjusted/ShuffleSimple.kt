...
val Phosphor.ShuffleSimple: ImageVector
    get() {
        if (_shuffle_simple != null) {
            return _shuffle_simple!!
        }
        _shuffle_simple = Builder(
            name = "Shuffle-simple",
...
private var _shuffle_simple: ImageVector? = null



@Preview
@Composable
fun ShuffleSimplePreview() {
    Image(
        Phosphor.ShuffleSimple,
        null
    )
}
