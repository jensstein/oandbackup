...
val Phosphor.ArrowClockwise: ImageVector
    get() {
        if (_arrow_clockwise != null) {
            return _arrow_clockwise!!
        }
        _arrow_clockwise = Builder(
...
private var _arrow_clockwise: ImageVector? = null



@Preview
@Composable
fun ArrowClockwisePreview() {
    Image(
