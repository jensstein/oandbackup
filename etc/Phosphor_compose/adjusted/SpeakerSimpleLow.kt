...
val Phosphor.SpeakerSimpleLow: ImageVector
    get() {
        if (_speaker_simple_low != null) {
            return _speaker_simple_low!!
        }
        _speaker_simple_low = Builder(
...
private var _speaker_simple_low: ImageVector? = null



@Preview
@Composable
fun SpeakerSimpleLowPreview() {
    Image(
        Phosphor.SpeakerSimpleLow,
        null
    )
}
