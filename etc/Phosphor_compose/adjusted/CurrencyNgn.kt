...
val Phosphor.CurrencyNgn: ImageVector
    get() {
        if (_currency_ngn != null) {
            return _currency_ngn!!
        }
        _currency_ngn = Builder(
            name = "Currency-ngn",
...
private var _currency_ngn: ImageVector? = null



@Preview
@Composable
fun CurrencyNgnPreview() {
    Image(
        Phosphor.CurrencyNgn,
        null
    )
}
