...
val Phosphor.ArrowFatRight: ImageVector
    get() {
        if (_arrow_fat_right != null) {
            return _arrow_fat_right!!
        }
        _arrow_fat_right = Builder(
...
private var _arrow_fat_right: ImageVector? = null



@Preview
@Composable
fun ArrowFatRightPreview() {
    Image(
        Phosphor.ArrowFatRight,
        null
    )
}
