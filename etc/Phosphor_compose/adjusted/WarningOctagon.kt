...
val Phosphor.WarningOctagon: ImageVector
    get() {
        if (_warning_octagon != null) {
            return _warning_octagon!!
        }
        _warning_octagon = Builder(
...
private var _warning_octagon: ImageVector? = null



@Preview
@Composable
fun WarningOctagonPreview() {
    Image(
