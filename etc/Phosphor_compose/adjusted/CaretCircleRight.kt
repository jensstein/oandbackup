...
val Phosphor.CaretCircleRight: ImageVector
    get() {
        if (_caret_circle_right != null) {
            return _caret_circle_right!!
        }
        _caret_circle_right = Builder(
...
private var _caret_circle_right: ImageVector? = null



@Preview
@Composable
fun CaretCircleRightPreview() {
    Image(
        Phosphor.CaretCircleRight,
        null
    )
}
