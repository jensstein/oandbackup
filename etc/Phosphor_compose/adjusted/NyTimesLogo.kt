...
val Phosphor.NyTimesLogo: ImageVector
    get() {
        if (_ny_times_logo != null) {
            return _ny_times_logo!!
        }
        _ny_times_logo = Builder(
            name = "Ny-times-logo",
...
private var _ny_times_logo: ImageVector? = null



@Preview
@Composable
fun NyTimesLogoPreview() {
    Image(
        Phosphor.NyTimesLogo,
        null
    )
}
