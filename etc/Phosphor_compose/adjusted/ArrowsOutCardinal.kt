...
val Phosphor.ArrowsOutCardinal: ImageVector
    get() {
        if (_arrows_out_cardinal != null) {
            return _arrows_out_cardinal!!
        }
        _arrows_out_cardinal = Builder(
...
private var _arrows_out_cardinal: ImageVector? = null



@Preview
@Composable
fun ArrowsOutCardinalPreview() {
    Image(
