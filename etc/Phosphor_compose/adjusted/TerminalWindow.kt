...
val Phosphor.TerminalWindow: ImageVector
    get() {
        if (_terminal_window != null) {
            return _terminal_window!!
        }
        _terminal_window = Builder(
...
private var _terminal_window: ImageVector? = null



@Preview
@Composable
fun TerminalWindowPreview() {
    Image(
