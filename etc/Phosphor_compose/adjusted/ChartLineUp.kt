...
val Phosphor.ChartLineUp: ImageVector
    get() {
        if (_chart_line_up != null) {
            return _chart_line_up!!
        }
        _chart_line_up = Builder(
            name = "Chart-line-up",
...
private var _chart_line_up: ImageVector? = null



@Preview
@Composable
fun ChartLineUpPreview() {
    Image(
