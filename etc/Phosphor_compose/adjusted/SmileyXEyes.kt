...
val Phosphor.SmileyXEyes: ImageVector
    get() {
        if (_smiley_x_eyes != null) {
            return _smiley_x_eyes!!
        }
        _smiley_x_eyes = Builder(
            name = "Smiley-x-eyes",
...
private var _smiley_x_eyes: ImageVector? = null



@Preview
@Composable
fun SmileyXEyesPreview() {
    Image(
        Phosphor.SmileyXEyes,
        null
    )
}
