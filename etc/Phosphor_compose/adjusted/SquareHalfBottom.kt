...
val Phosphor.SquareHalfBottom: ImageVector
    get() {
        if (_square_half_bottom != null) {
            return _square_half_bottom!!
        }
        _square_half_bottom = Builder(
...
private var _square_half_bottom: ImageVector? = null



@Preview
@Composable
fun SquareHalfBottomPreview() {
    Image(
        Phosphor.SquareHalfBottom,
        null
    )
}
