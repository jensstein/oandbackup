...
val Phosphor.NumberCircleThree: ImageVector
    get() {
        if (_number_circle_three != null) {
            return _number_circle_three!!
        }
        _number_circle_three = Builder(
...
private var _number_circle_three: ImageVector? = null



@Preview
@Composable
fun NumberCircleThreePreview() {
    Image(
        Phosphor.NumberCircleThree,
        null
    )
}
