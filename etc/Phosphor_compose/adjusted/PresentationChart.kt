...
val Phosphor.PresentationChart: ImageVector
    get() {
        if (_presentation_chart != null) {
            return _presentation_chart!!
        }
        _presentation_chart = Builder(
...
private var _presentation_chart: ImageVector? = null



@Preview
@Composable
fun PresentationChartPreview() {
    Image(
