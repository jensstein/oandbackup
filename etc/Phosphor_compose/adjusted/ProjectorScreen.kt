...
val Phosphor.ProjectorScreen: ImageVector
    get() {
        if (_projector_screen != null) {
            return _projector_screen!!
        }
        _projector_screen = Builder(
...
private var _projector_screen: ImageVector? = null



@Preview
@Composable
fun ProjectorScreenPreview() {
    Image(
