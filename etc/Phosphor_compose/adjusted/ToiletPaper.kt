...
val Phosphor.ToiletPaper: ImageVector
    get() {
        if (_toilet_paper != null) {
            return _toilet_paper!!
        }
        _toilet_paper = Builder(
            name = "Toilet-paper",
...
private var _toilet_paper: ImageVector? = null



@Preview
@Composable
fun ToiletPaperPreview() {
    Image(
        Phosphor.ToiletPaper,
        null
    )
}
