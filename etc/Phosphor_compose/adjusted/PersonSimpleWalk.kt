...
val Phosphor.PersonSimpleWalk: ImageVector
    get() {
        if (_person_simple_walk != null) {
            return _person_simple_walk!!
        }
        _person_simple_walk = Builder(
...
private var _person_simple_walk: ImageVector? = null



@Preview
@Composable
fun PersonSimpleWalkPreview() {
    Image(
        Phosphor.PersonSimpleWalk,
        null
    )
}
