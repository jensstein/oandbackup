...
val Phosphor.SpeakerNone: ImageVector
    get() {
        if (_speaker_none != null) {
            return _speaker_none!!
        }
        _speaker_none = Builder(
            name = "Speaker-none",
...
private var _speaker_none: ImageVector? = null



@Preview
@Composable
fun SpeakerNonePreview() {
    Image(
        Phosphor.SpeakerNone,
        null
    )
}
