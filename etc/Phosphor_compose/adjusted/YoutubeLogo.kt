...
val Phosphor.YoutubeLogo: ImageVector
    get() {
        if (_youtube_logo != null) {
            return _youtube_logo!!
        }
        _youtube_logo = Builder(
            name = "Youtube-logo",
...
private var _youtube_logo: ImageVector? = null



@Preview
@Composable
fun YoutubeLogoPreview() {
    Image(
