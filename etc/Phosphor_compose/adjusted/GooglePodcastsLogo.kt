...
val Phosphor.GooglePodcastsLogo: ImageVector
    get() {
        if (_google_podcasts_logo != null) {
            return _google_podcasts_logo!!
        }
        _google_podcasts_logo = Builder(
...
private var _google_podcasts_logo: ImageVector? = null



@Preview
@Composable
fun GooglePodcastsLogoPreview() {
    Image(
        Phosphor.GooglePodcastsLogo,
        null
    )
}
