...
val Phosphor.MapPinLine: ImageVector
    get() {
        if (_map_pin_line != null) {
            return _map_pin_line!!
        }
        _map_pin_line = Builder(
            name = "Map-pin-line",
...
private var _map_pin_line: ImageVector? = null



@Preview
@Composable
fun MapPinLinePreview() {
    Image(
        Phosphor.MapPinLine,
        null
    )
