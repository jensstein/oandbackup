...
val Phosphor.DiscordLogo: ImageVector
    get() {
        if (_discord_logo != null) {
            return _discord_logo!!
        }
        _discord_logo = Builder(
            name = "Discord-logo",
...
private var _discord_logo: ImageVector? = null



@Preview
@Composable
fun DiscordLogoPreview() {
    Image(
        Phosphor.DiscordLogo,
        null
    )
}
