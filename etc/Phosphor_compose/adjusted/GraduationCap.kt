...
val Phosphor.GraduationCap: ImageVector
    get() {
        if (_graduation_cap != null) {
            return _graduation_cap!!
        }
        _graduation_cap = Builder(
            name = "Graduation-cap",
...
private var _graduation_cap: ImageVector? = null



@Preview
@Composable
fun GraduationCapPreview() {
    Image(
