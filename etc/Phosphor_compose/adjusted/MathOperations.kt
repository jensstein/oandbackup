...
val Phosphor.MathOperations: ImageVector
    get() {
        if (_math_operations != null) {
            return _math_operations!!
        }
        _math_operations = Builder(
...
private var _math_operations: ImageVector? = null



@Preview
@Composable
fun MathOperationsPreview() {
    Image(
        Phosphor.MathOperations,
        null
    )
}
