...
val Phosphor.SpeakerSlash: ImageVector
    get() {
        if (_speaker_slash != null) {
            return _speaker_slash!!
        }
        _speaker_slash = Builder(
            name = "Speaker-slash",
...
private var _speaker_slash: ImageVector? = null



@Preview
@Composable
fun SpeakerSlashPreview() {
    Image(
