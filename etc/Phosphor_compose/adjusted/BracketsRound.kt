...
val Phosphor.BracketsRound: ImageVector
    get() {
        if (_brackets_round != null) {
            return _brackets_round!!
        }
        _brackets_round = Builder(
            name = "Brackets-round",
...
private var _brackets_round: ImageVector? = null



@Preview
@Composable
fun BracketsRoundPreview() {
    Image(
        Phosphor.BracketsRound,
        null
    )
}
