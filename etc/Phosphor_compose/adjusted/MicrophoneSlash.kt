...
val Phosphor.MicrophoneSlash: ImageVector
    get() {
        if (_microphone_slash != null) {
            return _microphone_slash!!
        }
        _microphone_slash = Builder(
...
private var _microphone_slash: ImageVector? = null



@Preview
@Composable
fun MicrophoneSlashPreview() {
    Image(
        Phosphor.MicrophoneSlash,
        null
    )
}
