...
val Phosphor.WindowsLogo: ImageVector
    get() {
        if (_windows_logo != null) {
            return _windows_logo!!
        }
        _windows_logo = Builder(
            name = "Windows-logo",
...
private var _windows_logo: ImageVector? = null



@Preview
@Composable
fun WindowsLogoPreview() {
    Image(
        Phosphor.WindowsLogo,
        null
    )
}
