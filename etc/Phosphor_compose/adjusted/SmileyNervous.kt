...
val Phosphor.SmileyNervous: ImageVector
    get() {
        if (_smiley_nervous != null) {
            return _smiley_nervous!!
        }
        _smiley_nervous = Builder(
            name = "Smiley-nervous",
...
private var _smiley_nervous: ImageVector? = null



@Preview
@Composable
fun SmileyNervousPreview() {
    Image(
        Phosphor.SmileyNervous,
        null
    )
}
