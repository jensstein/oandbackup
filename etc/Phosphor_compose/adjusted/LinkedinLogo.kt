...
val Phosphor.LinkedinLogo: ImageVector
    get() {
        if (_linkedin_logo != null) {
            return _linkedin_logo!!
        }
        _linkedin_logo = Builder(
            name = "Linkedin-logo",
...
private var _linkedin_logo: ImageVector? = null



@Preview
@Composable
fun LinkedinLogoPreview() {
    Image(
