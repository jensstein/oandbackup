...
val Phosphor.AlignCenterVertical: ImageVector
    get() {
        if (_align_center_vertical != null) {
            return _align_center_vertical!!
        }
        _align_center_vertical = Builder(
...
private var _align_center_vertical: ImageVector? = null



@Preview
@Composable
fun AlignCenterVerticalPreview() {
    Image(
