...
val Phosphor.SelectionPlus: ImageVector
    get() {
        if (_selection_plus != null) {
            return _selection_plus!!
        }
        _selection_plus = Builder(
            name = "Selection-plus",
...
private var _selection_plus: ImageVector? = null



@Preview
@Composable
fun SelectionPlusPreview() {
    Image(
        Phosphor.SelectionPlus,
        null
    )
}
