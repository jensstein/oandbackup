...
val Phosphor.CellSignalFull: ImageVector
    get() {
        if (_cell_signal_full != null) {
            return _cell_signal_full!!
        }
        _cell_signal_full = Builder(
...
private var _cell_signal_full: ImageVector? = null



@Preview
@Composable
fun CellSignalFullPreview() {
    Image(
        Phosphor.CellSignalFull,
        null
    )
}
