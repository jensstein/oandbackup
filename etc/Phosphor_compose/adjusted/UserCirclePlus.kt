...
val Phosphor.UserCirclePlus: ImageVector
    get() {
        if (_user_circle_plus != null) {
            return _user_circle_plus!!
        }
        _user_circle_plus = Builder(
...
private var _user_circle_plus: ImageVector? = null



@Preview
@Composable
fun UserCirclePlusPreview() {
    Image(
        Phosphor.UserCirclePlus,
        null
    )
}
