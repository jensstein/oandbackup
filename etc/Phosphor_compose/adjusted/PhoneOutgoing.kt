...
val Phosphor.PhoneOutgoing: ImageVector
    get() {
        if (_phone_outgoing != null) {
            return _phone_outgoing!!
        }
        _phone_outgoing = Builder(
            name = "Phone-outgoing",
...
private var _phone_outgoing: ImageVector? = null



@Preview
@Composable
fun PhoneOutgoingPreview() {
    Image(
        Phosphor.PhoneOutgoing,
        null
    )
}
