...
val Phosphor.CaretCircleDoubleRight: ImageVector
    get() {
        if (_caret_circle_double_right != null) {
            return _caret_circle_double_right!!
        }
        _caret_circle_double_right = Builder(
...
private var _caret_circle_double_right: ImageVector? = null



@Preview
@Composable
fun CaretCircleDoubleRightPreview() {
    Image(
        Phosphor.CaretCircleDoubleRight,
        null
    )
}
