...
val Phosphor.PersonSimpleRun: ImageVector
    get() {
        if (_person_simple_run != null) {
            return _person_simple_run!!
        }
        _person_simple_run = Builder(
...
private var _person_simple_run: ImageVector? = null



@Preview
@Composable
fun PersonSimpleRunPreview() {
    Image(
        Phosphor.PersonSimpleRun,
        null
    )
}
