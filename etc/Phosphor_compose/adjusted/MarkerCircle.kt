...
val Phosphor.MarkerCircle: ImageVector
    get() {
        if (_marker_circle != null) {
            return _marker_circle!!
        }
        _marker_circle = Builder(
            name = "Marker-circle",
...
private var _marker_circle: ImageVector? = null



@Preview
@Composable
fun MarkerCirclePreview() {
    Image(
        Phosphor.MarkerCircle,
        null
    )
}
