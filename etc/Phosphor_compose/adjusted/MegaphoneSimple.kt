...
val Phosphor.MegaphoneSimple: ImageVector
    get() {
        if (_megaphone_simple != null) {
            return _megaphone_simple!!
        }
        _megaphone_simple = Builder(
...
private var _megaphone_simple: ImageVector? = null



@Preview
@Composable
fun MegaphoneSimplePreview() {
    Image(
