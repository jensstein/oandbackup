...
val Phosphor.LineSegment: ImageVector
    get() {
        if (_line_segment != null) {
            return _line_segment!!
        }
        _line_segment = Builder(
            name = "Line-segment",
...
private var _line_segment: ImageVector? = null



@Preview
@Composable
fun LineSegmentPreview() {
    Image(
        Phosphor.LineSegment,
        null
    )
}
