...
val Phosphor.MicrosoftPowerpointLogo: ImageVector
    get() {
        if (_microsoft_powerpoint_logo != null) {
            return _microsoft_powerpoint_logo!!
        }
        _microsoft_powerpoint_logo = Builder(
...
private var _microsoft_powerpoint_logo: ImageVector? = null



@Preview
@Composable
fun MicrosoftPowerpointLogoPreview() {
    Image(
        Phosphor.MicrosoftPowerpointLogo,
        null
    )
}
