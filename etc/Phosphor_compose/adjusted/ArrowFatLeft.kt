...
val Phosphor.ArrowFatLeft: ImageVector
    get() {
        if (_arrow_fat_left != null) {
            return _arrow_fat_left!!
        }
        _arrow_fat_left = Builder(
            name = "Arrow-fat-left",
...
private var _arrow_fat_left: ImageVector? = null



@Preview
@Composable
fun ArrowFatLeftPreview() {
    Image(
        Phosphor.ArrowFatLeft,
        null
    )
}
