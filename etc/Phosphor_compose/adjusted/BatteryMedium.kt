...
val Phosphor.BatteryMedium: ImageVector
    get() {
        if (_battery_medium != null) {
            return _battery_medium!!
        }
        _battery_medium = Builder(
            name = "Battery-medium",
...
private var _battery_medium: ImageVector? = null



@Preview
@Composable
fun BatteryMediumPreview() {
    Image(
        Phosphor.BatteryMedium,
        null
    )
}
