...
val Phosphor.ArrowURightUp: ImageVector
    get() {
        if (_arrow_u_right_up != null) {
            return _arrow_u_right_up!!
        }
        _arrow_u_right_up = Builder(
...
private var _arrow_u_right_up: ImageVector? = null



@Preview
@Composable
fun ArrowURightUpPreview() {
    Image(
        Phosphor.ArrowURightUp,
        null
    )
}
