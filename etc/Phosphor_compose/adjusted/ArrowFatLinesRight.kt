...
val Phosphor.ArrowFatLinesRight: ImageVector
    get() {
        if (_arrow_fat_lines_right != null) {
            return _arrow_fat_lines_right!!
        }
        _arrow_fat_lines_right = Builder(
...
private var _arrow_fat_lines_right: ImageVector? = null



@Preview
@Composable
fun ArrowFatLinesRightPreview() {
    Image(
        Phosphor.ArrowFatLinesRight,
        null
    )
}
