...
val Phosphor.ArrowFatDown: ImageVector
    get() {
        if (_arrow_fat_down != null) {
            return _arrow_fat_down!!
        }
        _arrow_fat_down = Builder(
            name = "Arrow-fat-down",
...
private var _arrow_fat_down: ImageVector? = null



@Preview
@Composable
fun ArrowFatDownPreview() {
    Image(
