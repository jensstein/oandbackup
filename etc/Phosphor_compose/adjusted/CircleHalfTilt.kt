...
val Phosphor.CircleHalfTilt: ImageVector
    get() {
        if (_circle_half_tilt != null) {
            return _circle_half_tilt!!
        }
        _circle_half_tilt = Builder(
...
private var _circle_half_tilt: ImageVector? = null



@Preview
@Composable
fun CircleHalfTiltPreview() {
    Image(
        Phosphor.CircleHalfTilt,
        null
    )
}
