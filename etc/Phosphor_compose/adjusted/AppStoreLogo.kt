...
val Phosphor.AppStoreLogo: ImageVector
    get() {
        if (_app_store_logo != null) {
            return _app_store_logo!!
        }
        _app_store_logo = Builder(
            name = "App-store-logo",
...
private var _app_store_logo: ImageVector? = null



@Preview
@Composable
fun AppStoreLogoPreview() {
    Image(
        Phosphor.AppStoreLogo,
        null
    )
}
