...
val Phosphor.ArticleNyTimes: ImageVector
    get() {
        if (_article_ny_times != null) {
            return _article_ny_times!!
        }
        _article_ny_times = Builder(
...
private var _article_ny_times: ImageVector? = null



@Preview
@Composable
fun ArticleNyTimesPreview() {
    Image(
        Phosphor.ArticleNyTimes,
        null
    )
}
