...
val Phosphor.IdentificationBadge: ImageVector
    get() {
        if (_identification_badge != null) {
            return _identification_badge!!
        }
        _identification_badge = Builder(
...
private var _identification_badge: ImageVector? = null



@Preview
@Composable
fun IdentificationBadgePreview() {
    Image(
