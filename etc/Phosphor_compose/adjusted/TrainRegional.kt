...
val Phosphor.TrainRegional: ImageVector
    get() {
        if (_train_regional != null) {
            return _train_regional!!
        }
        _train_regional = Builder(
            name = "Train-regional",
...
private var _train_regional: ImageVector? = null



@Preview
@Composable
fun TrainRegionalPreview() {
    Image(
        Phosphor.TrainRegional,
        null
    )
}
