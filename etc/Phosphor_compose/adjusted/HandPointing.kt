...
val Phosphor.HandPointing: ImageVector
    get() {
        if (_hand_pointing != null) {
            return _hand_pointing!!
        }
        _hand_pointing = Builder(
            name = "Hand-pointing",
...
private var _hand_pointing: ImageVector? = null



@Preview
@Composable
fun HandPointingPreview() {
    Image(
