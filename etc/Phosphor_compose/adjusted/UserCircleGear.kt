...
val Phosphor.UserCircleGear: ImageVector
    get() {
        if (_user_circle_gear != null) {
            return _user_circle_gear!!
        }
        _user_circle_gear = Builder(
...
private var _user_circle_gear: ImageVector? = null



@Preview
@Composable
fun UserCircleGearPreview() {
    Image(
        Phosphor.UserCircleGear,
        null
    )
}
