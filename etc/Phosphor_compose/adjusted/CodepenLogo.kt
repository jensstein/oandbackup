...
val Phosphor.CodepenLogo: ImageVector
    get() {
        if (_codepen_logo != null) {
            return _codepen_logo!!
        }
        _codepen_logo = Builder(
            name = "Codepen-logo",
...
private var _codepen_logo: ImageVector? = null



@Preview
@Composable
fun CodepenLogoPreview() {
    Image(
        Phosphor.CodepenLogo,
        null
    )
}
