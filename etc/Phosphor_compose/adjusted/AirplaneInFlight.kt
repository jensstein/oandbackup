...
val Phosphor.AirplaneInFlight: ImageVector
    get() {
        if (_airplane_in_flight != null) {
            return _airplane_in_flight!!
        }
        _airplane_in_flight = Builder(
...
private var _airplane_in_flight: ImageVector? = null



@Preview
@Composable
fun AirplaneInFlightPreview() {
    Image(
        Phosphor.AirplaneInFlight,
        null
    )
}
