...
val Phosphor.PaintBucket: ImageVector
    get() {
        if (_paint_bucket != null) {
            return _paint_bucket!!
        }
        _paint_bucket = Builder(
            name = "Paint-bucket",
...
private var _paint_bucket: ImageVector? = null



@Preview
@Composable
fun PaintBucketPreview() {
    Image(
        Phosphor.PaintBucket,
        null
    )
}
