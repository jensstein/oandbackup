...
val Phosphor.ArrowBendUpLeft: ImageVector
    get() {
        if (_arrow_bend_up_left != null) {
            return _arrow_bend_up_left!!
        }
        _arrow_bend_up_left = Builder(
...
private var _arrow_bend_up_left: ImageVector? = null



@Preview
@Composable
fun ArrowBendUpLeftPreview() {
    Image(
