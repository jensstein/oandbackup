...
val Phosphor.HeartStraightBreak: ImageVector
    get() {
        if (_heart_straight_break != null) {
            return _heart_straight_break!!
        }
        _heart_straight_break = Builder(
...
private var _heart_straight_break: ImageVector? = null



@Preview
@Composable
fun HeartStraightBreakPreview() {
    Image(
        Phosphor.HeartStraightBreak,
        null
    )
}
