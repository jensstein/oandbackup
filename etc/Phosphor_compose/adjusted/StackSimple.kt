...
val Phosphor.StackSimple: ImageVector
    get() {
        if (_stack_simple != null) {
            return _stack_simple!!
        }
        _stack_simple = Builder(
            name = "Stack-simple",
...
private var _stack_simple: ImageVector? = null



@Preview
@Composable
fun StackSimplePreview() {
    Image(
        Phosphor.StackSimple,
        null
    )
}
