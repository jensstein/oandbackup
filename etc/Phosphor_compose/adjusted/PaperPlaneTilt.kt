...
val Phosphor.PaperPlaneTilt: ImageVector
    get() {
        if (_paper_plane_tilt != null) {
            return _paper_plane_tilt!!
        }
        _paper_plane_tilt = Builder(
...
private var _paper_plane_tilt: ImageVector? = null



@Preview
@Composable
fun PaperPlaneTiltPreview() {
    Image(
