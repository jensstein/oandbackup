...
val Phosphor.TrafficSignal: ImageVector
    get() {
        if (_traffic_signal != null) {
            return _traffic_signal!!
        }
        _traffic_signal = Builder(
            name = "Traffic-signal",
...
private var _traffic_signal: ImageVector? = null



@Preview
@Composable
fun TrafficSignalPreview() {
    Image(
        Phosphor.TrafficSignal,
        null
    )
}
