...
val Phosphor.SelectionAll: ImageVector
    get() {
        if (_selection_all != null) {
            return _selection_all!!
        }
        _selection_all = Builder(
            name = "Selection-all",
...
private var _selection_all: ImageVector? = null



@Preview
@Composable
fun SelectionAllPreview() {
    Image(
        Phosphor.SelectionAll,
        null
    )
}
