...
val Phosphor.MessengerLogo: ImageVector
    get() {
        if (_messenger_logo != null) {
            return _messenger_logo!!
        }
        _messenger_logo = Builder(
            name = "Messenger-logo",
...
private var _messenger_logo: ImageVector? = null



@Preview
@Composable
fun MessengerLogoPreview() {
    Image(
