...
val Phosphor.ComputerTower: ImageVector
    get() {
        if (_computer_tower != null) {
            return _computer_tower!!
        }
        _computer_tower = Builder(
            name = "Computer-tower",
...
private var _computer_tower: ImageVector? = null



@Preview
@Composable
fun ComputerTowerPreview() {
    Image(
        Phosphor.ComputerTower,
        null
    )
}
