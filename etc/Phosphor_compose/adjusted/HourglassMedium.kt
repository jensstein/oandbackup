...
val Phosphor.HourglassMedium: ImageVector
    get() {
        if (_hourglass_medium != null) {
            return _hourglass_medium!!
        }
        _hourglass_medium = Builder(
...
private var _hourglass_medium: ImageVector? = null



@Preview
@Composable
fun HourglassMediumPreview() {
    Image(
