...
val Phosphor.VideoCameraSlash: ImageVector
    get() {
        if (_video_camera_slash != null) {
            return _video_camera_slash!!
        }
        _video_camera_slash = Builder(
...
private var _video_camera_slash: ImageVector? = null



@Preview
@Composable
fun VideoCameraSlashPreview() {
    Image(
        Phosphor.VideoCameraSlash,
        null
    )
}
