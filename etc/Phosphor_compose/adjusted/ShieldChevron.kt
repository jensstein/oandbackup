...
val Phosphor.ShieldChevron: ImageVector
    get() {
        if (_shield_chevron != null) {
            return _shield_chevron!!
        }
        _shield_chevron = Builder(
            name = "Shield-chevron",
...
private var _shield_chevron: ImageVector? = null



@Preview
@Composable
fun ShieldChevronPreview() {
    Image(
