...
val Phosphor.CoinVertical: ImageVector
    get() {
        if (_coin_vertical != null) {
            return _coin_vertical!!
        }
        _coin_vertical = Builder(
            name = "Coin-vertical",
...
private var _coin_vertical: ImageVector? = null



@Preview
@Composable
fun CoinVerticalPreview() {
    Image(
        Phosphor.CoinVertical,
        null
    )
}
