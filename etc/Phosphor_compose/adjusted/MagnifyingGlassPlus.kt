...
val Phosphor.MagnifyingGlassPlus: ImageVector
    get() {
        if (_magnifying_glass_plus != null) {
            return _magnifying_glass_plus!!
        }
        _magnifying_glass_plus = Builder(
...
private var _magnifying_glass_plus: ImageVector? = null



@Preview
@Composable
fun MagnifyingGlassPlusPreview() {
    Image(
