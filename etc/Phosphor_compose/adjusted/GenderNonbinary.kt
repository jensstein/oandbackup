...
val Phosphor.GenderNonbinary: ImageVector
    get() {
        if (_gender_nonbinary != null) {
            return _gender_nonbinary!!
        }
        _gender_nonbinary = Builder(
...
private var _gender_nonbinary: ImageVector? = null



@Preview
@Composable
fun GenderNonbinaryPreview() {
    Image(
