...
val Phosphor.FlyingSaucer: ImageVector
    get() {
        if (_flying_saucer != null) {
            return _flying_saucer!!
        }
        _flying_saucer = Builder(
            name = "Flying-saucer",
...
private var _flying_saucer: ImageVector? = null



@Preview
@Composable
fun FlyingSaucerPreview() {
    Image(
        Phosphor.FlyingSaucer,
        null
    )
}
