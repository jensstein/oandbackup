...
val Phosphor.ArrowBendDownRight: ImageVector
    get() {
        if (_arrow_bend_down_right != null) {
            return _arrow_bend_down_right!!
        }
        _arrow_bend_down_right = Builder(
...
private var _arrow_bend_down_right: ImageVector? = null



@Preview
@Composable
fun ArrowBendDownRightPreview() {
    Image(
        Phosphor.ArrowBendDownRight,
        null
    )
}
