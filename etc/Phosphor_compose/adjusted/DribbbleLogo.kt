...
val Phosphor.DribbbleLogo: ImageVector
    get() {
        if (_dribbble_logo != null) {
            return _dribbble_logo!!
        }
        _dribbble_logo = Builder(
            name = "Dribbble-logo",
...
private var _dribbble_logo: ImageVector? = null



@Preview
@Composable
fun DribbbleLogoPreview() {
    Image(
        Phosphor.DribbbleLogo,
        null
    )
}
