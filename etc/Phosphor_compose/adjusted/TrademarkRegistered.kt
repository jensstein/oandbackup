...
val Phosphor.TrademarkRegistered: ImageVector
    get() {
        if (_trademark_registered != null) {
            return _trademark_registered!!
        }
        _trademark_registered = Builder(
...
private var _trademark_registered: ImageVector? = null



@Preview
@Composable
fun TrademarkRegisteredPreview() {
    Image(
        Phosphor.TrademarkRegistered,
        null
    )
}
