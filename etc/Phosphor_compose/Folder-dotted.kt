...
val Phosphor.`Folder-dotted`: ImageVector
    get() {
        if (`_folder-dotted` != null) {
            return `_folder-dotted`!!
        }
        `_folder-dotted` = Builder(
            name = "Folder-dotted", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_folder-dotted`: ImageVector? = null
